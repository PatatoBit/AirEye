        ...
        ScrollView {
            VStack(alignment: .leading) {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Text("The model analyzed 12,902 images, each labeled with its actual AQI. By constantly comparing its guess to the truth and correcting its own math, it taught itself to recognize the visual signatures of bad air.")
                }
...
struct TrainingSimulationView: View {
                ...
                if currentStep == .learning {
                    HStack {
                        Image(systemName: "gearshape.2.fill")
                            ...
                            .animation(.linear(duration: 1).repeatForever(autoreverses: false), value: currentStep)
    ...
    func parseFilename(_ filename: String) -> ParsedFile {
        ...
        guard components.count >= 4 else { return ParsedFile(time: "", dayNight: "", aqi: 0, weather: "") }
